...
image(matrix(as.matrix(training[3,17:2]*0+63), nrow=4), col=gray.colors(256, rev = TRUE, start = 0, end = 1), xlab = training[3,1], breaks=colbreaks)
...
newText <- "11111111111111111111111111111111111"
conf <- matrix(0,10,10)
last <- 1
for(i in last:200) {
  last <- i
  ...
  if(as.numeric((substr(newText, nchar(newText)-8, nchar(newText)-5)))<2){
